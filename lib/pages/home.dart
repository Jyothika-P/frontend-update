                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          return Padding(
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () => {
                                                                                if (snapshot.data[0][index][0] == 'Serenity')
                                                                                  {
                                                                                    Navigator.pushNamed(context, '/monkeybot', arguments: {
                                                                                      'receiverid': snapshot.data[0][index][0],
                                                                                      'currentid': currentUserId,
                                                                                      'lastmessage': snapshot.data[0][index][1]['message'],
                                                                                      'obj': place.getObject(),
                                                                              ...
                                                                              child: Container(
                                                                                decoration: BoxDecoration(
                                                                                  ...
                                                                                  boxShadow: [
                                                                                    BoxShadow(
                                                                                      color: (snapshot.data[0][index][0] == 'Serenity') ? Colors.grey.withOpacity(0.5) : Colors.black26, // Greyish color with opacity
                                                                                ...
                                                                                child: Padding(
                                                                                  padding: EdgeInsets.symmetric(horizontal: 9.0, vertical: (snapshot.data[0][index][0] == 'Serenity') ? 8.0 : 6.0),
                                                                                  child: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        child: !(snapshot.data[0][index][0] == "Serenity") ? RandomAvatar(snapshot.data[0][index][0], trBackground: false, height: 50, width: 50) : circleButton(constr, sizeWidth / 150, sizeWidth / 45, "assets/serenity_1.png", borderneed: false),
                                                                                      ),
                                                                                      Container(
                                                                                        width: sizeWidth / 2.6,
                                                                                        child: Column(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            Text(
                                                                                              (snapshot.data[0][index][0] == 'Serenity')
                                                                                                  ? "There for u 😇"
                                                                                                  : snapshot.data[0][index][1]['message'].length < 20
                                                                                                      ? snapshot.data[0][index][1]['message']
                                                                                                      : snapshot.data[0][index][1]['message'].substring(0, 20),
                                                                                              style: TextStyle(color: (snapshot.data[0][index][0] == 'Serenity') ? Color.fromRGBO(35, 154, 139, 75) : Colors.grey, fontFamily: 'AbeeZee'),
                                                                                            ),
                                                                                          ],
                                                                                        ),
                                                                                      ),
                                                                                      Container(
                                                                                        ...
                                                                                        child: Column(
                                                                                          ...
                                                                                          children: [
                                                                                            Text(
                                                                                              (() {
                                                                                                final msgDate = snapshot.data[0][index][1]['date'] ?? '';
                                                                                                final msgTimeStr = snapshot.data[0][index][1]['time'] ?? '';
                                                                                              ...
                                                                                              style: TextStyle(
                                                                                                color: (snapshot.data[0][index][0] == 'Serenity') ? Color.fromRGBO(35, 154, 139, 75) : Colors.grey,
                                                                                                fontStyle: FontStyle.italic,
                                                                                                fontFamily: 'ABeeZee',
                                                                                              ),
                                                                                            ),
