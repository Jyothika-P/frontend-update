                                                              ...
                                                              child: Container(
                                                                    ...
                                                                    BoxShadow(
                                                                      color: (snapshot.data[0][index][0] ==
                                                                          ...
                                                                          ? Colors
                                                                              .grey
                                                                              .withOpacity(0.5)
                                                                          : Colors.black26, // Greyish color with opacity
                                                                      spreadRadius:
                                                                          2, // Controls how far the shadow spreads
                                                                      blurRadius:
                                                                          3, // Controls the blurriness of the shadow
                                                                      offset: Offset(
                                                                          0,
                                                                ...
                                                                child: Padding(
                                                                  padding: EdgeInsets.symmetric(
                                                                      horizontal:
                                                                          9.0,
                                                                      vertical: (snapshot.data[0][index][0] ==
                                                                              'Serenity')
                                                                          ? 8.0
                                                                          : 6.0),
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child: !(snapshot.data[0][index][0] ==
                                                                                "Serenity")
                                                                            ? RandomAvatar(snapshot.data[0][index][0],
                                                                                trBackground: false,
                                                                                height: 50,
                                                                                width: 50)
                                                                            : circleButton(constr, sizeWidth / 150, sizeWidth / 45, "assets/serenity_1.png", borderneed: false),
                                                                      ),
                                                                      Container(
                                                                        width: sizeWidth /
                                                                            2.6,
